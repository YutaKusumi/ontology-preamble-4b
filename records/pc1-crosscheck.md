# PC1 交差検査（機械・再現可能）
生成: 2026-09-05 20:42／語彙: F3D7568C2FDA0BB7／対象 25 文書
...
対象＝モデルに送られる文言のみ（前置き・system・圧力/続行文・用量版・環境の凍結文言＝agent-env-spec-v2.md の ENV-BLOCK（複数可））。仕様書の散文は対象外（説明文の自己ヒットを避けるため・監査二巡目G3）。
