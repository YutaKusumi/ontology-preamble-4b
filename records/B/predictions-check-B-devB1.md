...
- 門の記録 `records/B/gate-B-2026-09-21.json`（SHA16 D56684A9A2914B2E・判定 open）・集計の記録 `records/B/analysis-B-devB1-2026-09-22.json`（SHA16 01E776A1E37B5BFB）・起草者の封印 `records/B/seal-B.json`（SHA-256 `2EFFFDF0CFB6A629A2E52369196B6785D39F58FEE16A32A875914051026B3E42`）。
...
|---|---|---|---|---|---|---|
| 登録者 | `records/predictions/predictions-registrant-B-2026-09-19.json` | 向き | 7 | 8 | 1 | 0 |
...
| コーディネータ | `records/predictions/predictions-coordinator-B-2026-09-19.json` | 向き | 5 | 10 | 1 | 0 |
| コーディネータ | `records/predictions/predictions-coordinator-B-2026-09-19.json` | S4 | 0 | 0 | 1 | 0 |
| コーディネータ | `records/predictions/predictions-coordinator-B-2026-09-19.json` | 全体 | 2 | 0 | 0 | 0 |

## 登録者——外れと照合不能

| 種別 | 欄 | 予想 | 結果 | 拠りどころ | 判定 |
|---|---|---|---|---|---|
| 向き | sub:N1:O-Ncold-v~O-Ncold-vrand | 上昇 | どちらでもない | 非有意 | 外れ |
| 向き | sub:S4:O-Ncold-v~O-Ncold-vrand | 上昇 | どちらでもない | 非有意 | 外れ |
| 向き | add:N1:Onull+v~Onull+vrand | 低下 | どちらでもない | 非有意 | 外れ |
...
| 全体 | b.all.confirmed_band | 9〜16 本 | 4〜8 本 | 確証の札 7 本（逆向きを含む） | 外れ |

## コーディネータ——外れと照合不能

| 種別 | 欄 | 予想 | 結果 | 拠りどころ | 判定 |
|---|---|---|---|---|---|
| 向き | sub:S1:O-Ncold-v~O-Ncold-vrand | どちらでもない | 上昇 | 確証（登録された向きと逆・逸脱 D-B1 の下） | 外れ |
| 向き | sub:SK:O-Ncold-v~O-Ncold-vrand | どちらでもない | 上昇 | 確証（登録された向きと逆・逸脱 D-B1 の下） | 外れ |
| 向き | add:S1:Onull+v~Onull+vrand | どちらでもない | 低下 | 確証（登録された向きと逆・逸脱 D-B1 の下） | 外れ |
| 向き | add:SK:Onull+v~Onull+vrand | どちらでもない | 低下 | 確証（登録された向きと逆・逸脱 D-B1 の下） | 外れ |
| 向き | add:S4:Onull+v~Onull+vrand | どちらでもない | 低下 | 確証（登録された向きと逆・逸脱 D-B1 の下） | 外れ |
| 向き | cross:N1:Onull+vNk~Onull+vrand | 低下 | どちらでもない | 非有意 | 外れ |
