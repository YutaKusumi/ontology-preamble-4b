...
用法: python extract_votes_results_r2.py <会話の記録 jsonl>"""
...
MARKS = [('Geminiさん（一人目）', 'gemini-1', 'Gemini 3.8 Flash（系統外）・一人目'),
         ...
         ('Claudeさん（一人目）', 'claude-ai-1', 'claude.ai の Claude Opus 5.5（起草者と同一系列・票が自ら系統内と申告）・一人目'),
         ('Claudeさん（二人目）', 'claude-ai-2', 'claude.ai の Claude Opus 5.5（起草者と同一系列・票が自ら系統内と申告）・二人目')]
best = None
for line in open(src, encoding='utf-8'):
    ...
    for t in texts:
        if all(m[0] in t for m in MARKS) and 'Opus 5.5' in t and '第二巡' in t:
