...
| ファイル | 断片 | 件数 | 推定トークン数 |
|---|---|---|---|
| `records/A/judge-files/judge-file-A-1of3.md` | F0001〜F0701 | 701 | 521,623 |
| `records/A/judge-files/judge-file-A-2of3.md` | F0702〜F1400 | 699 | 521,527 |
| `records/A/judge-files/judge-file-A-3of3.md` | F1401〜F2100 | 700 | 521,179 |
...
## 3. 一つの添付ファイルを一人の判定者に読んでもらう手順（判定者 4 名 × ファイル 3 本＝会話 12 回）
