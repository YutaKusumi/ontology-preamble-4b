# 段階 A 門と校正の器の合成検査（機械生成・`tools/synth_gates_A.py` v2.1・2026-09-14 07:35 UTC・ファイル名の日付は手元の日付〔日本時間〕）

- 入力: {"identity_screen_A.py": "759F005CDF01FA6C", "gate_A.py": "61CF8B2467722CDC", "calib_band_A.py": "DEE5EB3EDE884A50", "control_chart_A.py": "1958DFA2CC6F69CE", "integrity_A.py": "27D1677F28C3A0D9", "runs_A.py": "A57BE1F5EEACBBB2", "bands_A.py": "BFF15C1D51957E26", "synth_gates_A.py": "7ECC303483FF4D55"}・正本 SHA16 8B298F126E77CBE6
- 判定: PASS（33 項目中 33 一致）
...
| gates-pass: 初点の名乗りの移し替え（理由の記帳が無ければ止まる・退避の記録に元の名乗りと理由が残る・退避の後に別の機種が名乗れる・登録者裁定 D26） | ○ |  |
