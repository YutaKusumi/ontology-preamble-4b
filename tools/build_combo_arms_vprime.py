# -*- coding: utf-8 -*-
"""build_combo_arms_vprime.py —— 追補 V′ の組合せ腕 38 本（{O, Osec, Onull, Nk, Nlib, Nai}×{Ncold, NcoldS, Ncold3, Nneu1, Nneu2, Nneu3} の 36 本＋{O, Onull}×Nstr の 2 本・v3・後者は三巡目検器身高6 への登録者裁定 2026-09-07）を乙 V-combination-rule v2 §3 の式
...
自己検査: (a) 空行ちょうど 1 回 (b) split == [A,B] (c) 長さ = |A|+|B|+2 (d) 末尾「。」 (e′) 38 本の SHA 相異（反転対が無いため乙 (e) は適用外）。引数なし・再実行で同一バイト。
"""
...
MAT = {'O': ('arms/frozen-from-ryokai-os/armsE/preamble-O.md', 'F3EE60C33F825575', 268), 'Onull': ('arms/frozen-from-ryokai-os/armsE/preamble-Onull.md', '2123B3CD8586E7DF', 273),
       ...
       'Nstr': ('arms/panel/Nstr.md', '84EC1A8C8B931B35', 14),
...
PAIRS = [(x, c) for x in X for c in C] + [('O', 'Nstr'), ('Onull', 'Nstr')]
texts = {}
