# -*- coding: utf-8 -*-
"""build_combo_arms_vprime.py —— 追補 V′ の組合せ腕 18 本（{O, Osec, Onull, Nk, Nlib, Nai}×{Ncold, NcoldS, Ncold3}）を乙 V-combination-rule v2 §3 の式
...
X = ['O', 'Osec', 'Onull', 'Nk', 'Nlib', 'Nai']; C = ['Ncold', 'NcoldS', 'Ncold3']
texts = {}
