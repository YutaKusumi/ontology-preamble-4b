...
訂正点（v1 → v2）: 段III 分母から T2 の refuse/書式外を除く（§3.4）／段I′ は天井規則の対象外（§3.4）／O-Ncold 対 Ncold は下向き（出所: 乙 V-combination-rule v2 §4・凍結本文 §8 に該当箇所は無い・D-8）／段III に天井規則なし（分母極小は「検定不能・記述」）／
