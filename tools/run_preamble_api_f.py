# -*- coding: utf-8 -*-
"""run_preamble_api_f.py v2.6（v2.5＋段階 F の盤 arms/panelF/・台帳 SHA-LEDGER-F.json・system 型のガード・段階 F 専用・凍結走行器 v2.4／v2.5 は不変・2026-09-11。生成器 tools/make_runner_f.py・4 ハンク。user_message・strip_echo・_norm・_quoted_segments は v2.5 と関数単位で同一）
