# -*- coding: utf-8 -*-
"""make_contrasts_B.py v14 —— 段階 B の正本 `design/contrasts-B.json` を、再設計（登録者裁定 D4 (a)・D5・D3 (d)・D7（2026-09-13）と D57・D58・D68〜D74・D75〜D86（2026-09-18））から決定的に生成する（手書き禁止・再実行同一バイト）。
...
predictions = {
    ...
    'compare_rules': {
        ...
        'interpretation': {
            'status': '**起草者の解釈**（照合の器を書いたとき・2026-09-19 の夜・封印の後・**結果の前**）。上の規則に書かれていなかった所の写し方。**登録者の確認を待つ**',
